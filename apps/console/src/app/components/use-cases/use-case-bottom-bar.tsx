        ...
        <div className="flex h-10 w-full items-center px-4 text-xs text-neutral">
          ...
          <div className="flex h-10 min-w-0 flex-1 items-center gap-2 pl-4">
            ...
            <InputSelect
              ...
              className="min-w-0 flex-1 [&_.input-select__control]:!h-10 [&_.input-select__control]:!border-0 [&_.input-select__control]:!shadow-none [&_.input-select__control]:!bg-transparent [&_.input-select__value-container]:!top-0 [&_.input-select__value-container]:!mt-0 [&_.input-select__value-container]:!h-10 [&_.input-select__value-container]:!items-center [&_.input-select__single-value]:!font-mono [&_.input-select__single-value]:!text-xs [&_.input-select__single-value]:!text-neutral"
              inputClassName="input--inline !min-h-0 !h-10 !border-0 !bg-transparent !px-0 !py-0 !outline-none focus-within:!outline-none !shadow-none"
