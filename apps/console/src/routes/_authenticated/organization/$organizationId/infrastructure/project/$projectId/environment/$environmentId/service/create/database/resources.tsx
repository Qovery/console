...
function Resources() {
  ...
  const creationFlowUrl = `/organization/${organizationId}/infrastructure/project/${projectId}/environment/${environmentId}/service/create/database`
  ...
  if (!generalValues.name || !generalValues.type || !generalValues.version || !generalValues.mode) {
    return (
      <Navigate
        to="/organization/$organizationId/infrastructure/project/$projectId/environment/$environmentId/service/create/database/general"
        params={{
          organizationId,
          projectId,
          environmentId,
