...
export const NODE_ENV = process.env.NODE_ENV,
  ...
  QOVERY_FORUM_URL = 'https://discuss.qovery.com',
  QOVERY_STATUS_URL = 'https://status.qovery.com',
  QOVERY_DOCS_URL = 'https://hub.qovery.com',
  QOVERY_FEEDBACK_URL = 'https://roadmap.qovery.com',
  QOVERY_ROADMAP_URL = 'https://roadmap.qovery.com/roadmap'
