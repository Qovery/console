...
import {
  GpuResourcesSettings,
  NodepoolsResourcesSettings,
  SpotInstancesProductionWarning,
                      ...
                      >
                        ...
                        >
                            ...
                            {!props.fromDetail && (
                              <div className="flex flex-col gap-3 border-t border-neutral-250 p-4">
                                ...
                                <p className="text-xs text-neutral-350">
                                  This enables spot for Default and GPU nodepools. Stable nodepool always uses on-demand.
                                  You can customize spot per nodepool after cluster creation.
                                </p>
                                {props.isProduction && watchSpotEnabled && <SpotInstancesProductionWarning />}
                              </div>
                            )}
                            {props.fromDetail && (
                              <div className="flex flex-col gap-3 border-t border-neutral-250 p-4">
                          ...
                          {watchKarpenterEnabled && props.cluster && (
                            <NodepoolsResourcesSettings cluster={props.cluster} filter="default" isProduction={props.isProduction} />
                          )}
                        </motion.div>
                      </motion.div>
                    )}
            ...
            <AnimatePresence>
              {isGpuEnabled && (
                ...
                >
                  ...
                  {watchKarpenterEnabled && props.cluster && (
                    <NodepoolsResourcesSettings cluster={props.cluster} filter="gpu" isProduction={props.isProduction} />
                  )}
                </motion.div>
              )}
            </AnimatePresence>
