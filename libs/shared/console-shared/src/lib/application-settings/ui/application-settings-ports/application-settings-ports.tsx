...
export interface ApplicationSettingsPortsProps {
...
export function ApplicationSettingsPorts(props: ApplicationSettingsPortsProps) {
...
export default ApplicationSettingsPorts
