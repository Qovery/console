...
const FunnelFlowContent = (props: FunnelFlowProps) => {
  return (
    <div className="absolute inset-0 left-0 top-0 flex min-h-0 flex-col scroll-auto bg-background">
      <header className="flex h-16 shrink-0 items-center justify-between border-b border-surface-neutral-subtle px-5">
        ...
        {props.onExit && (
          <div className="flex h-full items-center border-l border-l-surface-neutral-subtle pl-5">
      ...
      <div data-testid="progress-bar-wrapper" className="relative h-[6px] shrink-0 bg-surface-neutral-component">
        <div
          ...
          className="absolute inset-0 h-full origin-left bg-brand-6 transition-transform duration-700 ease-in-out"
        />
      </div>
