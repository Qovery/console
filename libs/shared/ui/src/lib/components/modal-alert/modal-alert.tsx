...
export function ModalAlert(props: ModalAlertProps) {
  ...
  return (
    <Dialog.Root open={props.isOpen} onOpenChange={() => setModalAlertOpen(!props.isOpen)}>
      <Dialog.Portal>
        <Dialog.Overlay className="modal__overlay flex fixed top-0 left-0 bg-zinc-700/40 w-full h-screen z-40" />
        <Dialog.Content
        ...
        >
          <div className="max-h-[80vh] overflow-auto p-6">
            <h2 className="h4 text-zinc-400 mb-2">Discard changes?</h2>
