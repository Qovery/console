...
import EditionTable, { EditionTableProps } from './edition-table'

const props: EditionTableProps = {
  tableBody: [
    {
...
describe('EditionTable', () => {
  it('should render successfully', () => {
    const { baseElement } = render(<EditionTable {...props} />)
    expect(baseElement).toBeTruthy()
  })

  it('should render 3 rows and 9 cells', () => {
    const { getAllByTestId } = render(<EditionTable {...props} />)
