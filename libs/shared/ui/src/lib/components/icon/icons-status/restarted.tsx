...
export const RestartedIcon = forwardRef<ElementRef<'div'>, IconStatusProps>(function RestartedIcon(
  { className = '', width = 16, height = 16 },
  forwardedRef
) {
  return (
    <div className={twMerge('text-green-500', className)} ref={forwardedRef}>
