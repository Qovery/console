...
export function HelmServiceIcon(props: IconProps) {
  return (
    <svg xmlns="http://www.w3.org/2000/svg" {...props} fill="none" viewBox="0 0 24 24">
      <circle cx="12" cy="12" r="10" stroke="#EAEAFE" strokeWidth="2"></circle>
      <circle cx="12" cy="12" r="11.3" stroke="#42E8E0" strokeOpacity="0.3"></circle>
      <circle cx="12" cy="12" r="10.9" stroke="#42E8E0" strokeWidth="0.2"></circle>
      <g clipPath="url(#clip0_6005_35604)">
      ...
      <defs>
        <linearGradient id="paint0_linear_6005_35604" x1="12" x2="12" y1="3" y2="20.953" gradientUnits="userSpaceOnUse">
          <stop stopColor="#AEB0EE"></stop>
