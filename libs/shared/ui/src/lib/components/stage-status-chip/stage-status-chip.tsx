  ...
  const icon = match(status)
    ...
    .with('CANCELED', 'CANCEL', () => (
      <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
        ...
        <path
          fill="#101420"
          d="M12.85 6H11.4a.4.4 0 00-.4.4v6.7c0 .22.18.4.4.4h1.45a.4.4 0 00.4-.4V6.4a.4.4 0 00-.4-.4zM11 15.4v1.45c0 .22.18.4.4.4h1.45a.4.4 0 00.4-.4V15.4a.4.4 0 00-.4-.4H11.4a.4.4 0 00-.4.4z"
        ></path>
      </svg>
    ))
    .with('ERROR', () => (
