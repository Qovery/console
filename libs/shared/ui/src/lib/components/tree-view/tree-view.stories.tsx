...
const Story: Meta<typeof TreeView.Root> = {
...
export const Primary = {
  render: () => (
    <TreeView.Root type="single" collapsible>
      <TreeView.Item value="item-1">
        <TreeView.Trigger>What is Lorem Ipsum?</TreeView.Trigger>
        <TreeView.Content>
          <TreeView.Root type="single" collapsible>
            <TreeView.Item value="item-1">
              <TreeView.Trigger>What is Lorem Ipsum?</TreeView.Trigger>
      ...
      <TreeView.Item value="item-2">
        <TreeView.Trigger>Where does it come from?</TreeView.Trigger>
        <TreeView.Content>
      ...
      <TreeView.Item value="item-3">
        <TreeView.Trigger>Why do we use it?</TreeView.Trigger>
        <TreeView.Content>
