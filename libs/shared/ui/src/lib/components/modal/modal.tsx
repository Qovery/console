          ...
          <div className="max-h-[80vh] overflow-auto">
            ...
            {buttonClose && (
              <Dialog.Close className="absolute top-4 right-4">
                <span className="flex w-7 h-7 items-center justify-center bg-element-light-lighter-400 text-zinc-350 hover:text-text-500 hover:bg-element-light-lighter-500 ease-out duration-300 rounded-full">
