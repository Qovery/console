...
describe('NavigationLeft', () => {
  ...
  it('should have active class', () => {
    ...
    expect(linkClassName('/general', props.links[0].url)).toContain(
      'flex items-center py-2 px-3 text-ssm rounded font-medium cursor-pointer mt-0.5 transition ease-out duration-300 truncate is-active text-brand bg-surface-brand-subtle hover:text-brand-hover hover:bg-surface-brand-component'
    )
  })
