    ...
    switch (eventType) {
      ...
      case OrganizationEventType.DELETE:
        return (
          <Tag
            ...
            className="bg-zinc-100 text-element-light-lighter-700 border border-zinc-250 !h-6"
          >
      ...
      case OrganizationEventType.TRIGGER_DELETE:
        return (
          <Tag
            fontWeight="font-medium"
            className="bg-zinc-100 text-element-light-lighter-700 border border-zinc-250 !h-6 truncate"
          >
