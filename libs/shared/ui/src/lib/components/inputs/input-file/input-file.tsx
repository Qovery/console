...
export function InputFile(props: InputFileProps) {
  ...
  return (
    <label
      ...
      className={`relative flex h-[72px] w-[72px] cursor-pointer items-center justify-center rounded border border-dashed border-neutral bg-surface-neutral-subtle duration-150 ease-out ${
        !selectedImage ? 'hover:bg-surface-neutral-component' : 'bg-surface-neutral-subtle'
      } ${className}`}
    >
      <input
