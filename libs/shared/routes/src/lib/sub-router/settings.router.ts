...
export const SETTINGS_CREDENTIALS_URL = '/credentials'
...
export const SETTINGS_ARGOCD_INTEGRATION_URL = '/argocd-integration'
...
export const SETTINGS_AI_COPILOT_URL = '/ai-copilot'
