...
export const APPLICATION_SETTINGS_TERRAFORM_VARIABLES_URL = '/terraform-variables'
export const APPLICATION_SETTINGS_TERRAFORM_RESOURCES_URL = '/terraform-resources'
