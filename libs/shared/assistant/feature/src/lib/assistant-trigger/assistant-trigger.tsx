  ...
  return (
    <>
      {match(assistantIcon)
        ...
        .with('PAPERCLIP', () => (
          <button
            className="group fixed bottom-8 right-8 flex h-14 w-14 items-center justify-center overflow-hidden rounded-full text-neutral-50 outline-brand-600 drop-shadow-2xl transition hover:animate-[showAssistantTrigger_0.2s_cubic-bezier(0.21,1.02,0.73,1)_forwards]"
            onClick={() => setAssistantOpen(!assistantOpen)}
          >
            <img
