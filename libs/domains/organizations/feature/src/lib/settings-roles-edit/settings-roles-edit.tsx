...
function SettingsRolesEditContent({
  ...
  const { reset, handleSubmit: handleFormSubmit, control, formState } = useFormContext()
          ...
          <>
            <div className="mb-8 flex justify-between">
              <div>
                ...
                <h1 className="h5 mb-2 text-neutral">Edit your custom role: {customRole.name}</h1>
            ...
            <form onSubmit={onSubmit}>
              ...
              {customRole?.cluster_permissions && <TableClusters clusters={customRole?.cluster_permissions} />}
              {customRole?.project_permissions && (
                <Table
                ...
                >
                  {customRole.project_permissions.map((project: OrganizationCustomRoleProjectPermissionsInner) => (
              ...
              <div className="mb-24 mt-6 flex justify-between gap-3">
                <Button
                  ...
                  color="red"
                  size="lg"
                  onClick={() => onDeleteRole(customRole)}
                >
                  Delete role
                </Button>
                <Button
