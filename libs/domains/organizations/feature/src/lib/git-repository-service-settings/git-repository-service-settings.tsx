...
export interface GitRepositoryServiceSettingsProps {
  gitDisabled: boolean
...
export function GitRepositoryServiceSettings({
  gitDisabled,
  editGitSettings,
  currentRepository,
  currentProvider,
  ...
  urlRepository,
  organizationId,
}: GitRepositoryServiceSettingsProps) {
    ...
    <div className="flex flex-col gap-4">
      ...
      {gitDisabled && editGitSettings && currentProvider && currentRepository && (
        <div className="flex justify-end">
          ...
          >
            Edit
            <Icon data-align="suffix" iconName="triangle-exclamation" className="text-sm text-yellow-500" />
          </Button>
        </div>
      )}
    </div>
...
export default GitRepositoryServiceSettings
