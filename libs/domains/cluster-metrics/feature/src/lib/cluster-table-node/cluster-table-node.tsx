      ...
      <Tooltip
        content={
          <div className="flex flex-col gap-1 font-normal">
            <div className="border-neutralInvert flex items-center justify-between border-b">
            ...
            <div className="border-neutralInvert flex items-center justify-between border-t px-2.5 py-1.5">
