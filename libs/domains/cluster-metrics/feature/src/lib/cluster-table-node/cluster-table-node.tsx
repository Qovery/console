      ...
      <Tooltip
        content={
          <div className="flex flex-col gap-1 font-normal">
            <div className="flex items-center justify-between border-b border-neutral-invert">
            ...
            <div className="flex items-center justify-between border-t border-neutral-invert px-2.5 py-1.5">
