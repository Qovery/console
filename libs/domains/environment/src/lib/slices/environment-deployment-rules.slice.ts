...
export const editEnvironmentDeploymentRules = createAsyncThunk(
  ...
  async (payload: { environmentId: string; deploymentRuleId: string; data: EnvironmentDeploymentRule }) => {
    const cloneEnvironmentDeploymentRules = Object.assign({}, payload.data as any)

    delete cloneEnvironmentDeploymentRules['id']
    delete cloneEnvironmentDeploymentRules['created_at']
    delete cloneEnvironmentDeploymentRules['updated_at']
    ...
    builder
      ...
      .addCase(editEnvironmentDeploymentRules.fulfilled, (state: EnvironmentDeploymentRulesState, action) => {
        const update: Update<EnvironmentDeploymentRule> = {
          id: action.meta.arg.deploymentRuleId,
          changes: {
            ...action.payload,
          },
        }
