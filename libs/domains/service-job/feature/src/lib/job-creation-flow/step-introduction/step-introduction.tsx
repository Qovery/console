...
function Card({ title, content, className, children }: CardProps) {
  return (
    ...
    >
      <div className="w-full bg-surface-brand-component p-0.5 sm:max-w-[196px]">
        <div className="flex h-full w-full flex-col gap-2 rounded-[14px] bg-background">
          <h1 className="flex p-3 pb-0 text-[28px] text-brand">
            {title}
...
export function StepIntroduction() {
  ...
  const { setCurrentStep, templateType } = useJobCreateContext()
        ...
        <Section className="flex flex-col gap-10">
          ...
          <div className="flex flex-col items-center gap-6 md:flex-row md:items-start md:gap-1">
            ...
            <Icon
              ...
              className="mt-8 hidden text-brand motion-safe:animate-[fadein_0.3s_ease-in-out_forwards_150ms] motion-safe:opacity-0 md:block"
            />
            <Card
              title="Trigger"
            ...
            <Icon
              iconName="angles-right"
              className="mt-8 hidden text-brand  motion-safe:animate-[fadein_0.3s_ease-in-out_forwards_250ms] motion-safe:opacity-0 md:block"
            />
            <Card
              title="Run"
              content={match(templateType)
            ...
            <Icon
              iconName="angles-right"
              className="mt-8 hidden text-brand  motion-safe:animate-[fadein_0.3s_ease-in-out_forwards_350ms] motion-safe:opacity-0 md:block"
            />
            <Card
              title="Output"
              content={match(templateType)
          ...
          <div className="mx-auto flex w-full flex-col items-center gap-5  motion-safe:animate-[fadein_0.3s_ease-in-out_forwards_350ms] motion-safe:opacity-0 md:w-[480px]">
            <div className="flex w-full justify-between">
              <div className="flex items-center">
                ...
                />
                <label className="text-sm font-medium text-neutral" htmlFor="dont-show-again">
                  Do not show again
                </label>
              </div>
