...
export interface DatabaseGeneralSettingsProps {
  database: Database
...
export function DatabaseGeneralSettings({
  ...
  return (
    <>
      ...
      <Section className="gap-4">
        ...
        {databaseVersionLoading ? (
          ...
          <>
            ...
            />
            {database.mode === DatabaseModeEnum.CONTAINER && formState.dirtyFields['version'] && (
              <Callout.Root color="yellow">
                <Callout.Icon>
            ...
            {database.mode === DatabaseModeEnum.MANAGED && formState.dirtyFields['version'] && (
              <Callout.Root color="yellow">
                <Callout.Icon>
              ...
              <p className="mt-2 text-sm text-neutral">
                {match({ watchMode, watchAccessibility })
                  .with(
                    ...
                    () => (
                      <>
                        <span className="font-medium">Private access to your database is ensured</span>, as it is only
                        accessible from within your cluster or via our port-forward feature. This setup is recommended
                  ...
                  .with(
                    ...
                    () => (
                      <>
                        <span className="font-medium">Private access to your database is ensured</span>, as it is only
                        accessible from within your cloud network. This configuration is recommended for security
                        reasons.
                      </>
                    )
                  )
                  .with({ watchMode: 'CONTAINER', watchAccessibility: 'PUBLIC' }, () => (
                    <>
                      ...
                      accessible to authorized users from anywhere, both inside and outside your cluster, allowing for
                  ...
                  .with({ watchMode: 'MANAGED', watchAccessibility: 'PUBLIC' }, () => (
                    <>
                      <span className="font-medium">Public access to your database is enabled</span>, making it
                      accessible to authorized users from anywhere, both inside and outside your cloud network, allowing
                      for broad access, collaboration, or testing purposes.
                    </>
                  ))
                  .exhaustive()}
              </p>
      ...
      {database.mode === DatabaseModeEnum.CONTAINER && (
        <Section className="gap-4">
...
export default DatabaseGeneralSettings
