              ...
              <div className="p-6">
                <div className="flex flex-col gap-2">
                  <Dialog.Title asChild>
                    <Heading level={2}>How custom build commands work</Heading>
                  </Dialog.Title>
                  <div>
                    ...
                    <div>
                      <label className="grid grid-cols-[16px_1fr] gap-3">
                        ...
                        <div className="flex flex-col gap-1">
                          ...
                          <span className="text-sm text-neutral-subtle">Type RUN commands to install tools.</span>
                        </div>
                      </label>
