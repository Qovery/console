...
export function StepSummaryPresentation(props: StepSummaryPresentationProps) {
  ...
  const checkIfScwNetworkFeaturesAvailable = () => {
    ...
    const features = props.featuresData.features
    ...
    <Section>
      ...
      <div className="mb-10">
          ...
          <Callout.Root color="sky" className="mb-5 items-start">
            ...
            <Callout.Text>
              ...
              <Callout.TextDescription>
                Manage this cluster through the Qovery console instead of your cloud provider console. Automatic
                maintenance, patching, and scheduled updates are handled for you.{' '}
              ...
              >
                <div className="mr-2 flex-grow">
                  ...
                  <div className="space-y-4">
                    ...
                    <div>
                      <span className="text-sm font-bold text-neutral-subtle">MetalLB</span>
                      <ul className="list-none space-y-2 text-sm text-neutral-subtle">
                        <li>
                    ...
                    <div>
                      <span className="text-sm font-bold text-neutral-subtle">Nginx</span>
                      <ul className="list-none space-y-2 text-sm text-neutral-subtle">
                        <li>
        ...
        <div className="mt-10 flex justify-between">
          <Button onClick={props.onPrevious} type="button" size="lg" color="neutral" variant="plain">
            Back
          </Button>
