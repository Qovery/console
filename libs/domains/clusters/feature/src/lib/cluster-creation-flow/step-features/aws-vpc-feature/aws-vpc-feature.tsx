    ...
    <div className="flex flex-col justify-between rounded border border-neutral bg-surface-neutral-component p-4">
      <div className="flex justify-between">
        <div>
          ...
          <p className="mb-4 text-sm text-neutral-subtle">In your VPC settings, you must enable the DNS hostnames.</p>
        </div>
        {isTooltipAvailable() && (
          <Tooltip content={<TooltipContent values={getValues('aws_existing_vpc')} />}>
            <span className="text-sm font-medium text-surface-brand-component">
      ...
      />
      <h4 className="mb-3 text-sm font-medium text-neutral">Mandatory subnet IDs</h4>
      ...
      <h4 className="mb-3 text-sm font-medium text-neutral">Subnet IDs for managed databases (optional)</h4>
