    ...
    <Section className="w-full px-8 py-6">
      ...
      {alertReceivers.length === 0 ? (
        <div className="mt-8 flex flex-col items-center justify-center overflow-hidden rounded border border-neutral-250 bg-neutral-100 p-10 text-center">
          <Icon iconName="bell" iconStyle="regular" className="mb-2.5 text-xl text-neutral-350" />
          <p className="font-medium">No notification channel added yet</p>
        ...
        <>
          ...
          <div className="mt-8 flex flex-col gap-3">
            ...
            {slackReceivers.length === 0 ? (
              <div className="overflow-hidden rounded border border-neutral-250 bg-neutral-100 p-6 text-center">
                <p className="text-sm text-neutral-350">No Slack channel configured yet</p>
              </div>
            ) : (
            ...
            {emailReceivers.length === 0 ? (
              <div className="flex flex-col items-center justify-center overflow-hidden rounded border border-dashed border-neutral-250 bg-neutral-100 p-10 text-center">
                ...
                <Button
                  ...
                  color="neutral"
                  className="gap-1.5"
                  onClick={createEmailChannelModal}
                >
                  <Icon iconName="circle-plus" iconStyle="regular" />
                  Add email group
                </Button>
