...
import { RdsWriteLatencyChart } from './rds-write-latency-chart'
...
describe('RdsWriteLatencyChart', () => {
  ...
  it('should render successfully', () => {
    const { container } = renderWithProviders(
      <RdsWriteLatencyChart serviceId="service-1" clusterId="cluster-1" dbInstance="zb4b3b048-postgresql" />
    )
