...
import { type AlertConfiguration, BulkCreationFlow } from '../../service-creation-flow/bulk-creation-flow'
...
export function ServiceAlerting() {
    ...
    openModal({
      content: (
        <CreateKeyAlertsModal
          ...
          service={service}
          onSubmit={(data) => {
            setSelectedMetrics(data.metricCategories)
            closeModal()
  ...
  const handleBulkCreationComplete = (alerts: AlertConfiguration[]) => {
    console.log('Creating alerts:', alerts)
    // TODO: Implement API call to create alerts
    setShowBulkCreation(false)
    setSelectedMetrics([])
  }
  ...
  return (
    <>
      {showBulkCreation && service && (
        <BulkCreationFlow
          selectedMetrics={selectedMetrics}
          serviceId={service.id}
          serviceName={service.name}
          onClose={handleBulkCreationClose}
          onComplete={handleBulkCreationComplete}
        />
      )}
