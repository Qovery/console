...
describe('calculateDynamicRange', () => {
  ...
  it('should return 30000ms for duration < 24 hours', () => {
    const startTimestamp = '1704067200' // Jan 1, 2024 00:00:00
  ...
  it('should return 60000ms for duration < 48 hours', () => {
    const startTimestamp = '1704067200' // Jan 1, 2024 00:00:00
  ...
  it('should return 120000ms for duration < 7 days', () => {
    const startTimestamp = '1704067200' // Jan 1, 2024 00:00:00
  ...
  it('should return 300000ms for duration < 30 days', () => {
    const startTimestamp = '1704067200' // Jan 1, 2024 00:00:00
  ...
  it('should return 1800000ms for duration < 60 days', () => {
    const startTimestamp = '1704067200' // Jan 1, 2024 00:00:00
