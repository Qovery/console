...
describe('calculateDynamicRange', () => {
  it('should return 60000ms for 1 hour duration', () => {
  ...
  it('should return 630000ms for 23 hours duration', () => {
    const startTimestamp = '1704067200' // Jan 1, 2024 00:00:00
  ...
  it('should return 630000ms for 24 hours duration', () => {
    const startTimestamp = '1704067200' // Jan 1, 2024 00:00:00
  ...
  it('should return 1830000ms for 48 hours duration', () => {
    const startTimestamp = '1704067200' // Jan 1, 2024 00:00:00
    const endTimestamp = '1704240000' // Jan 3, 2024 00:00:00 (48 hours)

    expect(calculateDynamicRange(startTimestamp, endTimestamp)).toBe('1830000ms')
  })

  it('should return 7230000ms for 7 days duration', () => {
    const startTimestamp = '1704067200' // Jan 1, 2024 00:00:00
    const endTimestamp = '1704672000' // Jan 8, 2024 00:00:00 (7 days)

    expect(calculateDynamicRange(startTimestamp, endTimestamp)).toBe('7230000ms')
  })

  it('should return 21630000ms for 30 days duration', () => {
    const startTimestamp = '1704067200' // Jan 1, 2024 00:00:00
    const endTimestamp = '1706659200' // Jan 31, 2024 00:00:00 (30 days)

    expect(calculateDynamicRange(startTimestamp, endTimestamp)).toBe('21630000ms')
  })

  it('should return 21630000ms for 60 days duration', () => {
    const startTimestamp = '1704067200' // Jan 1, 2024 00:00:00
  ...
  it('should apply offset multiplier', () => {
    ...
    expect(calculateDynamicRange(startTimestamp, endTimestamp, offsetMultiplier)).toBe('180000ms')
  })
  ...
  it('should handle edge case: exactly 12 hours', () => {
    ...
    expect(calculateDynamicRange(startTimestamp, endTimestamp)).toBe('330000ms')
  })
