...
export function VariableList({
  ...
  const renderTable = (
    ...
    return (
      <div className={twMerge('flex flex-col', !isTabLayout && 'grow justify-between')}>
        {headerActions && (
  ...
  return (
    <div className={twMerge('flex flex-col', !isTabLayout && 'min-h-0 gap-8')}>
      {showOnly !== 'built-in' && nonBuiltInVariables.length > 0 && (
        <section className={twMerge('flex flex-col gap-4', !isTabLayout && 'min-h-0')}>
