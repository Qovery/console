...
import { useVariablesSecretManagers } from '../hooks/use-variables-secret-managers/use-variables-secret-managers'
...
jest.mock('../hooks/use-variables-secret-managers/use-variables-secret-managers', () => ({
