...
describe('ServiceActions', () => {
  ...
  it('should render cloud shell button in header and navigate to the service overview', async () => {
    ...
    await userEvent.click(screen.getByLabelText(/qovery cloud shell/i))
  ...
  it('should call shellAction override when cloud shell button is clicked in header', async () => {
  ...
  it('should render cloud shell in default other actions and navigate to the service overview', async () => {
    const { userEvent } = renderWithProviders(
      <ServiceActions serviceId={mockService.id} environment={mockEnvironment} />,
      {
        container: document.body,
  ...
  it('should not render cloud shell button for databases by default', async () => {
  ...
  it('should not render cloud shell button for databases even with shellAction override', async () => {
    mockService = databaseFactoryMock(1)[0]
    const shellAction = jest.fn()
