      ...
      <div className="flex flex-col gap-6 pb-20">
        ...
        <section className="flex flex-col gap-2">
          <div className="flex items-center justify-between">
            <h2 className="text-sm font-medium leading-5 text-neutral">Estimated deployment impact</h2>
            <div className="flex items-center gap-1.5 text-xs text-neutral-subtle">
