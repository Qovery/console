...
export type AgenticWorkflowAutomationTriggerType = 'application' | 'schedule' | 'webhook'
...
export type AgenticWorkflowAutomationOutputType = 'application' | 'webhook'

export interface AgenticWorkflowAutomationOutput {
  id: string
...
export interface AgenticWorkflowAutomation {
  ...
  prompt: string
  outputs: AgenticWorkflowAutomationOutput[]
}
