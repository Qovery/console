...
function ServiceInstancesSection({
  jobStatusesCallout,
  service,
}: {
  jobStatusesCallout?: ReactNode
...
function ServiceScaledObjectSection({ scaledObject }: { scaledObject: ScaledObjectStatusDto }) {
  return (
    <Section className="gap-3">
...
function ServiceTerraformResourcesSection({
  service,
