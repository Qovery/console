  ...
  const agentUseCases: ServiceBlock[] = useMemo(
    () => [
      ...AGENTIC_WORKFLOW_TEMPLATES.map((template) => ({
        ...
        icon: (
          <span style={{ display: 'flex', alignItems: 'center', justifyContent: 'center' }}>
            <Icon iconName={template.iconName} iconStyle="regular" className="text-base text-[#918EDB]" />
          </span>
        ),
      ...
      },
      {
        ...
        icon: (
          <span style={{ display: 'flex', alignItems: 'center', justifyContent: 'center' }}>
            <Icon iconName="paper-plane" iconStyle="regular" className="text-base text-[#918EDB]" />
          </span>
        ),
