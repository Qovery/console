...
import { Button, Icon, type SelectedItem, type TableFilterProps } from '@qovery/shared/ui'
      ...
      <div className="flex w-full items-center gap-2">
        ...
        <div className="flex flex-row-reverse">
          {badges
            ...
            .slice()
            .reverse()
            .map((badge, reversedIndex, array) => {
              const isFirst = reversedIndex === array.length - 1
