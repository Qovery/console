...
import { Button, DatePicker, Icon, InputFilter, MultipleSelector, type Option } from '@qovery/shared/ui'
import { dateYearMonthDayHourMinuteSecond } from '@qovery/shared/util-dates'
import { SelectedTimestamps } from '../../feature/custom-filter-feature/custom-filter-feature'
    ...
    <>
      ...
      <div className="relative flex w-full items-center gap-1 text-ssm font-medium text-neutral-350">
        ...
        {searchParams.toString()?.length > 0 && (
          <span className="link shrink-0 cursor-pointer text-[#6033f0]" onClick={clearFilter}>
            Clear all
          </span>
        )}
      </div>
