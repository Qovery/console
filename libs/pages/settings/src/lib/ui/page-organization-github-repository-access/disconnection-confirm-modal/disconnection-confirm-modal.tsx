  ...
  return (
    <div className="p-6">
      ...
      <BannerBox
        ...
        message="Removing the Qovery Github App will reset the accesses to your repositories and user your Github account to get the authorisation. Make sure that your Github account has the access permissions to the repositories shown in the “Authorised Repositories section."
