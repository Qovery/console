                  ...
                  <div className="space-y-4 text-xs text-neutral-350">
                    <div>
                      ...
                      <p className="mt-2">
                        ...
                        assist users with the Qovery platform through intelligent documentation retrieval and automated
                        actions (subject to user confirmation).
                      </p>
                    </div>
                    ...
                    <div>
                      ...
                      <ul className="ml-4 list-disc space-y-1">
                        ...
                        <li>
                          <span className="font-medium">Read-Write Mode:</span> The AI Copilot can view and modify your
                          infrastructure configuration after explicit user confirmation for each action
                        </li>
                      </ul>
                    </div>
                    ...
                    <div>
                      ...
                      <p>
                        <span className="font-medium">3.3. Voluntary Adoption:</span> Use of the AI Copilot is entirely
                        optional and not required to use the Qovery platform.
                      </p>
                    </div>
                    ...
                    <div>
                      <p className="mb-2 font-semibold text-neutral-400">5. User Responsibilities and Acceptable Use</p>
                      <p className="mb-2">
                    ...
                    <div>
                      ...
                      <ul className="ml-4 list-disc space-y-1">
                        ...
                        <li>
                          Qovery is not liable for any damages, losses, or service disruptions resulting from AI Copilot
                          usage, including but not limited to: misconfigured resources, unintended deletions or
                          modifications, service interruptions, or data loss
                        </li>
                      </ul>
                      <p className="mt-2">
                    ...
                    <div>
                      ...
                      <p className="mb-2">
                        ...
                        sole discretion and without prior notice, to suspend or revoke access to the AI Copilot feature
                        for your organization, suspend or terminate your Qovery account and services, or investigate
                        suspected violations of these AI Terms.
                      </p>
                      <p>
                        <span className="font-medium">7.2. Grounds for Suspension:</span> Actions that may result in
                        suspension or termination include, but are not limited to: attempts to jailbreak, manipulate, or
                        bypass AI model constraints, abusive or malicious use, violations of applicable laws, or any
                        violation of these AI Terms or the Qovery Terms of Service.
                      </p>
                    </div>
                    ...
                    <div>
                      ...
                      <p>
                        ...
                        constitutes acceptance of the modified terms. Material changes will be communicated through the
                        Qovery platform or via email.
                      </p>
                    </div>
                    ...
                    <div>
                      ...
                      <p>
                        If any provision of these AI Terms is found to be unenforceable or invalid, that provision will
                    ...
                    <div>
                      ...
                      <p>
                        These AI Terms are governed by the same laws and jurisdiction provisions as the Qovery Terms of
                        Service.
                      </p>
                    </div>
