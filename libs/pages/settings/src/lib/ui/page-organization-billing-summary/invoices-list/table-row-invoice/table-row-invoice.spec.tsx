...
import { TableRowInvoice, TableRowInvoiceProps } from './table-row-invoice'
        ...
        filter: [
          {
            ...
            itemContentCustom: (item) => (
              <span className="text-neutral-400 text-sm font-medium">{dateToFormat(item.created_at, 'MMM dd, Y')}</span>
            ),
          },
        ],
      },
