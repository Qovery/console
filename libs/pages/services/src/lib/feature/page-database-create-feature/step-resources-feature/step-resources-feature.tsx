...
export function StepResourcesFeature() {
  ...
  const { setCurrentStep, resourcesData, setResourcesData, generalData, databaseURL } = useDatabaseCreateContext()
  ...
  const onSubmit = methods.handleSubmit((data) => {
    ...
    navigate(databaseURL + SERVICES_DATABASE_CREATION_POST_URL)
  })
