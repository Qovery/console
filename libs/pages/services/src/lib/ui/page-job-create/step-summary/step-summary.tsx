        ...
        <div className="flex flex-col gap-6">
          <Section className="p-4 border rounded border-neutral-250 bg-neutral-100">
            ...
            <ul className="flex flex-col gap-2 text-neutral-400 text-sm list-none">
              ...
              <li>
                <strong className="font-medium">Description:</strong> {props.generalData.description}
              </li>
              <div className="py-2">
              ...
              {props.generalData.serviceType === ServiceTypeEnum.CONTAINER && (
                <>
                  ...
                  <li>
                    <strong className="font-medium">Image entrypoint:</strong> {props.generalData.image_entry_point}
                  </li>
                  <li>
                    <strong className="font-medium">CMD arguments:</strong> {props.configureData.cmd_arguments}
                  </li>
                  <li>
                    <strong className="font-medium">Auto-deploy:</strong> {props.generalData.auto_deploy.toString()}
                  </li>
              ...
              <>
                <ul className="flex flex-col gap-2 text-neutral-400 text-sm list-none">
                  ...
                  {props.configureData.image_entry_point && (
                    <li>
                      <strong className="font-medium">Entrypoint:</strong> {props.configureData.image_entry_point}
                    </li>
                  )}
