...
export const colors = ['#5B50D6', '#B160F0', '#FF7C00', '#009EDD', '#44C979']
const randomIndex = Math.floor(Math.random() * colors.length)

export function BadgeDeploymentOrder(props: BadgeDeploymentOrderProps) {
  const { deploymentOrder = 0 } = props

  return (
    <div data-testid="badge" className="relative drop-shadow-sm flex mr-2">
      <svg width="20" height="20" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg">
        <path
          ...
          fill={deploymentOrder < colors.length - 1 ? colors[deploymentOrder] : colors[randomIndex]}
