...
export function StepThanks(props: StepThanksProps) {
  ...
  return (
    <div className="pb-10">
      <h1 className="h3 text-zinc-400 mb-3">Almost there..</h1>
      <p className="text-sm mb-5 text-zinc-400">Hey {firstName}, thanks for signing up!</p>
      ...
      <div className="text-sm text-center border border-element-light-lighter-500 bg-element-light-lighter-200 text-zinc-400 px-4 py-2.5 rounded mb-5">
        {email}
      </div>
      <p className="text-sm mb-5 text-zinc-400">
