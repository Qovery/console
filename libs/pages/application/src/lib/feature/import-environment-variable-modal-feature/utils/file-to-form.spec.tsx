...
describe('fileToForm Function', () => {
  it('should return a defaultValues object from json', () => {
    expect(jsonToForm(JSON.stringify(jsonFile))).toEqual({
      key1_key: 'key1',
      key1_value: 'value1',
      key1_scope: EnvironmentVariableScopeEnum.BUILT_IN,
      key1_secret: 'true',
      key2_key: 'key2',
      key2_value: 'value2',
      key2_scope: EnvironmentVariableScopeEnum.BUILT_IN,
      key2_secret: 'true',
      key3_key: 'key3',
      key3_value: 'value3',
      key3_scope: EnvironmentVariableScopeEnum.BUILT_IN,
      key3_secret: 'true',
      keyEmpty_key: 'keyEmpty',
      keyEmpty_value: '',
      keyEmpty_scope: EnvironmentVariableScopeEnum.BUILT_IN,
