...
describe('RowDeployment', () => {
  ...
  it('should have success index color', () => {
    ...
    expect(index).toHaveClass('text-green-500 bg-zinc-550 group-hover:bg-element-light-darker-400')
  })
  ...
  it('should have error index color', () => {
    ...
    expect(index).toHaveClass('text-red-500 bg-zinc-550 group-hover:bg-element-light-darker-400')
  })
